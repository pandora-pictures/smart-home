...
export class DevicesPage implements OnInit {
  ...
  ngOnInit() {
    this.deviceService.pinstatus.subscribe( selection => {
      this.obj = selection;
    });
    this.deviceService.pinstatus1.subscribe( selection => {
      this.status1 = selection;
    });
    this.deviceService.pinstatus2.subscribe( selection => {
      this.status2 = selection;
    });
    this.deviceService.pinstatus3.subscribe( selection => {
      this.status3 = selection;
    });
    this.deviceService.getBordStatus();
  }
  ...
  toggle( id ) {
    this.deviceService.togglePin( id );
